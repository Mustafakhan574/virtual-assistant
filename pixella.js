...
function takecommand(message){
    ...
    voice.style.display = "none";
          ...
          else if(message.includes("who is nasim mewati")||message.includes("who is naseem mewati")){
            speak(" nasim mewati proper palwal ka rehne wala hai : nasim mewati nehru collge ka bca second year ka student hai,currently he is preparing for government job");
          }
