...
function takecommand(message){
    ...
    voice.style.display = "none";
          ...
          else if(message.includes("salam pixella")||message.includes("pixella assalam walekum")||message.includes("pixela assalam walekum")){
            speak("walekum assalam");
          }
          else if(message.includes("pixella who are your boss")||message.includes("pixella hu r u")){
